...
<ul>
  <li>Não usar a tag <br> para espaçamento</li>
  <li>Estruturação de div</li>
  <li>Noção do display flex</li>
</ul>
<h3>Acesso</h3>
<p>Para acessar o projeto, clique no link: https://luizmiguelld.github.io/projetoLogin/</p>
